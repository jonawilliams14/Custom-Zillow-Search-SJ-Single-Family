...
2. Include real `lat` and `lon` values for each listing so distance and Google Maps links work.
3. Paste the CSV into the hosted page and click `Generate report`, or run:
